...
//   const filteredTotalItems = filteredCart.reduce((total, item) => total + item.quantity, 0);
...
//               const product = item.product || {};
//               const productId = product.uid || item.uid || item.id;

//               // Agar productId yo'q bo'lsa – o'tkazib yuboramiz (xavfsizlik)
//               if (!productId) return null;

//               return (
//                 <div
//                   key={productId}  // To'g'ri key – xato yo'q!
...
//                         <button onClick={() => updateQuantity(productId, item.quantity - 1)} className="p-1 rounded-lg bg-gray-100 hover:bg-gray-200">
